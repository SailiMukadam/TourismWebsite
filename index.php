...
<body>
		...
		<div id="sidebar">
			...
			<ul id="navigation">
				...
				<li class="color"><a href="#">City-wise Places</a>
					<ul><li><a href="place.php?id='dhk'">Dhaka</a></li>
						<li><a href="#">Chittagong</a></li>
  ...
  <form method="post">
   <textarea type"text" name="sp" id="sp" placeholder="Input The Place Name To Search"></textarea>
   </br>
   <input type="submit" name="sf" id="sf" value="Search" />
   <?php
    if (isset($_POST['sf'])) 
    {
     $ql="SELECT * FROM places WHERE place_name LIKE '%".$_POST['sp']."%'";
     $r=$db->query($ql);
     if ($r) 
     {
